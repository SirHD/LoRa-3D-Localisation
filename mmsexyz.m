...
%Estimate distances from each node
 for i = 1 : a(1)
    ...
    temp = mmse(node1(i,4), node1(i,5), node1(i,6), dist1(i), node2(i,4), node2(i,5), node2(i,6), dist2(i), node3(i,4), node3(i,5), node3(i,6), dist3(i), node4(i,4), node4(i,5), node4(i,6), dist4(i));
